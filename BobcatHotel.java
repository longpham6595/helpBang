...
public class BobcatHotel {
	public static void main(String[] args) {
		...
		if (randomNum >= 4)
		{
			int nightsDiscount = night /4;
			//System.out.println("Number of discount nights: " + nightsDiscount);
			System.out.println("Congratulation! You have been qualifiend for our \"Stay 4 nights get 1 free promotion\" ");
			System.out.println("Discount will be applied during checkout depending on the number of days");
			Clubmemberdiscount = nightsDiscount * Roomcost / night;
